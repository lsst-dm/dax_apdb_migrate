"""Migration script for ApdbCassandra 1.2.0.

Revision ID: ApdbCassandra_1.2.0
Revises: ApdbCassandra_1.1.0
Create Date: 2025-10-14 16:11:53.000777
"""
...
revision = "ApdbCassandra_1.2.0"
down_revision = "ApdbCassandra_1.1.0"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    """Upgrade 'ApdbCassandra' tree from 1.1.0 to 1.2.0 (ticket DM-52827).
